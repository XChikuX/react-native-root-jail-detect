...
namespace margelo::nitro::rootjaildetect::bridge::swift {
  ...
  Func_void_std__string create_Func_void_std__string(void* NON_NULL swiftClosureWrapper) noexcept {
    auto swiftClosure = RootJailDetect::Func_void_std__string::fromUnsafe(swiftClosureWrapper);
  ...
  Func_void_std__exception_ptr create_Func_void_std__exception_ptr(void* NON_NULL swiftClosureWrapper) noexcept {
    auto swiftClosure = RootJailDetect::Func_void_std__exception_ptr::fromUnsafe(swiftClosureWrapper);
